...
const Invite = ({ onclose }) => {
  ...
  return (
    <div className="absolute z-10 top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50">
      <div
        className="bg-white shadow-2xl relative z-20 transition-transform duration-200 rounded-md"
        onWheel={handleWheel}
      >
        <div className="flex flex-col justify-center w-full">
          <div className="flex justify-between items-center bg-darkRed w-full px-4 py-2 p-2 gap-10 rounded-t-md">
