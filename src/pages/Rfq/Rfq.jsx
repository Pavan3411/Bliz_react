    ...
    <div className="flex w-full  overflow-hidden px-5 gap-5">
      ...
      <div className="w-full mt-5 flex flex-col gap-5">
        <div className="flex flex-col sm:flex-row sm:justify-between bg-white shadow-md p-4 w-full sm:items-center rounded-md">
          <h1 className="font-extrabold md:font-bold text-xl text-lightRed px-2  ">
            Total RFQ
          </h1>
          <div className="flex space-x-3 justify-between mt-2  md:mt-0">
            <span className="relative">
              <input
                type="text"
                placeholder="Search"
                className="rounded-md border-[1px] border-gray-200 p-2 focus:outline-none placeholder:text-center  placeholder:text-sm w-28"
              />
        ...
        <div className="bg-white shadow-md w-full rounded-md p-4">
          ...
          <div className="overflow-x-auto md:overflow-hidden scrollbar-thin scrollbar-thumb-lightRed scrollbar-track-fadeRed lg:w-full md:w-full">
            <div className="text-gray-400 xl:text-sm text-xs grid items-center w-[150%] md:w-[98%] px-3 grid-cols-[0.4fr,2fr,1.6fr,2fr,2fr,1fr] mt-7 md:mx-3 mx-2  font-semibold">
              <input
                type="checkbox"
                className="border-[1px] border-gray-500 w-4 h-4"
              />
              <p>Order ID</p>
              <p>Payment Method</p>
              <p>Date Created</p>
            ...
            <div
              className="xl:text-sm text-xs grid w-[150%] md:w-[98%] grid-cols-[0.4fr,2fr,1.6fr,2fr,2fr,1fr] mt-7 lg:mx-3 md:mx-3 mx-[5px] items-center p-1 py-3 px-3 bg-gray-200"
            ...
            >
              ...
              <button className="bg-red-100 text-red-900 text-[10px] font-semibold border-[1px] border-red-200 rounded-md flex justify-center items-center w-16 h-4">
                Credit
              </button>
              <p className="lg:font-semibold font-bold">06 Oct 2022 8:00 AM</p>
              <p className="lg:font-semibold font-bold">07 Oct 2022 9:00 AM</p>
              <button className="bg-fadeRed text-darkRed text-[10px] border-[1px] border-lightRed  font-semibold rounded-md lg:w-20 md:w-20 h-6 flex justify-center items-center">
                Processing
              </button>
            </div>
            {isOpen && (
              <div className="md:border lg:mx-3 md:mx-3 mx-1 md:w-[98%]  w-[150%]">
                <div className="grid lg:grid-cols-[1.5fr,1fr,1fr,1fr,0.3fr] md:grid-cols-[1.5fr,1fr,1fr,1fr,0.3fr] grid-cols-[1.2fr,1fr,1fr,1fr,0.3fr] items-center p-3 py-6">
                  <h2 className="font-semibold lg:text-sm md:text-sm text-xs flex flex-col gap-1 lg:flex-row">
                  ...
                  <div className="space-y-[2px]">
                    <p className="lg:text-sm text-xs text-lightRed">
                      Date Created
                    </p>
                    <p className="lg:text-[14px] md:text-[14px] text-xs font-medium">
                      06 Oct 2022 8:00AM
                    </p>
                  </div>
                  <div className="space-y-[2px]">
                  ...
                  <div className="space-y-[2px]">
                    <p className="lg:text-sm text-xs text-lightRed ml-4">
                      Status
                    </p>
                    <button className="bg-fadeRed text-darkRed text-[10px] border-[1px] border-lightRed  font-semibold rounded-md lg:w-20 md:w-20 w-16 h-6 flex justify-center items-center">
                      processing
                    </button>
                  </div>
                  <div>
                ...
                <div className="flex justify-start md:justify-around gap-4 lg:gap-2 xl:gap-4 whitespace-nowrap mx-1 md:w-[98%]">
                  <div className="flex xl:gap-5 gap-0">
                    <div className="py-2 hidden md:inline-block lg:hidden xl:inline-block">
                      <span className="xl:h-12 xl:w-12 h-9 w-9 bg-gray-300 rounded-md flex items-center justify-center">
                        <User2Icon className="xl:h-6 xl:w-6 w-5 h-5 text-darkRed" />
                      </span>
                    </div>
                    <div className="flex flex-col gap-y-2 p-2 py-3">
                      <span className="flex gap-2 items-center">
                        <p className="text-lightRed font-bold text-sm xl:text-base whitespace-nowrap">
                          Contact Person
                        </p>
                  ...
                  <div className="flex xl:gap-5 gap-0">
                    <div className="p-2 hidden md:inline-block lg:hidden xl:inline-block">
                      <span className="xl:h-12 xl:w-12 h-9 w-9 bg-gray-300 rounded-md flex items-center justify-center">
                        <TruckIcon className="xl:h-6 xl:w-6 w-5 h-5 text-darkRed" />
                      </span>
                    </div>
                  ...
                  <div className="flex lg:gap-5 gap-0">
                    <div className="p-2 hidden md:inline-block lg:hidden xl:inline-block">
                      <span className="xl:h-12 xl:w-12  h-9 w-9 bg-gray-300 rounded-md flex items-center justify-center">
                        <PaymentIcon className="xl:h-6 xl:w-6 w-5 h-5 text-darkRed" />
                      </span>
                    </div>
                    <div className="flex flex-col gap-y-2 py-3">
                      <span className="flex gap-2 items-center">
                        <p className="text-lighRed font-bold text-sm whitespace-nowrap xl:text-base">
                          Payment Method
                        </p>
                        <TickIcon className="text-green-700 w-5 h-5 " />
                        <EditIcon className="w-5 h-5" />
                ...
                <div className="gap-5 flex flex-col lg:flex-row justify-between  lg:px-5 md:px-4 px-2 mt-2">
                  ...
                  <div className="flex flex-col gap-y-2">
                    ...
                    <textarea
                      ...
                      id="comment"
                      rows="3"
                      className="focus:outline-none p-2 border-[1px] focus:border-gray-500 w-7/12 lg:w-full"
                    ></textarea>
                  </div>
                </div>
                ...
                <div className="mt-4 rounded-md flex-col space-y-4 gap-10 text-sm justify-between items-center text-black font-semibold l mx-3 bg-fadeRed p-3 xl:hidden">
                  ...
                  <div className="flex justify-around">
                    <button className="bg-lightRed rounded-md w-24 h-7 gap-2 text-white flex justify-center items-center ">
                      Message
                      <ChatIcon className="w-4 h-4" />
                    </button>
                    <button className="bg-lightRed rounded-md w-16 h-7 text-white flex justify-center gap-2 items-center">
                      Print
                      <PrintIcon className="w-4 h-4" />
                    </button>
                    ...
                    <button className="bg-darkRed rounded-md w-20 h-7 p-1 gap-2 text-white flex justify-center items-center ">
                      Cancel
                      <CrossIcon className="w-4 h-4" />
                    </button>
                ...
                <div className="flex justify-end mt-2 mb-4 mr-3">
                  <button className="bg-fadeRed  rounded-md text- text-sm p-1 px-2 font-bold">
                    Compare Quotes
                  </button>
                </div>
              </div>
