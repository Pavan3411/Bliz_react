...
import AddressShimmer from '@pages/Address/AddressShimmer'
import AddressPopup from '@pages/Address/AddressPopup'
import { toast } from 'react-toastify'
import CommonButton from '../../components/reusables/Button'
import { useGetAddressMutation } from '../../features/address/addressApi'
...
const Address = () => {
  ...
  console.log("This is from RTK",addressData)
  ...
  const primaryIndex = addressData?.addresses?.findIndex(
    ...
    <div className="flex gap-5 w-full px-5">
      ...
      <div className="w-full mt-5">
        <div className="w-full py-2 bg-white rounded-md justify-between flex px-2 items-center mb-4">
          ...
          <CommonButton color='red' onClick={() => setAddAddress(true)} icon={LocationIcon}>
              ...
              <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50 w-full">
                ...
                >
                  ...
                  <div className="p-2 flex justify-end border-t-[1px] border-garyBorder">
                    ...
                    <CommonButton color='red' onClick={() => {
                      setEditable(false)
                      handleUpdate()
                    }} icon={LocationIcon}>
                      <p>Save</p>
              ...
              <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50 w-full">
                ...
                >
                  ...
                  <div className="p-2 flex justify-end border-t-[1px] border-grayHr">
                    ...
                    <CommonButton color='red' onClick={async () => {
                        const isValidAndSaved = await handleAddressSubmit()
                        if (isValidAndSaved) {
                          setAddAddress(false)
                        }
