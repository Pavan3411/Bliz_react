      ...
      {popUp && (
        ...
        >
          ...
          <div className="flex justify-end gap-2">
            ...
            <CommonButton color="gray" onClick={() => setPopUp(false)}>
              <p>Cancel</p>
            </CommonButton>
            {/* <button
      ...
      {deletePopUp && (
        ...
        >
          ...
          <div className="flex justify-end gap-2">
            ...
            <CommonButton color="gray" onClick={() => setDeletePopUp(false)}>
              <p>Cancel</p>
            </CommonButton>
            {/* <button
              className="bg-lightRed rounded-md flex items-center text-black gap-1 p-2 px-4"
      ...
      {primaryCheck && (
        ...
        >
          ...
          <div className="flex justify-end gap-2">
            ...
            <CommonButton color="red1" onClick={() => setPrimaryCheck(false)}>
              <p>OK</p>
            </CommonButton>
          </div>
        </div>
