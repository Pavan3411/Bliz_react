...
const FormRfq = () => {
  ...
  const handleGetValues = () => {
    //    const formValue = getValues('name') for multiple - array
  ...
  const fetchAttributes = async () => {
    try {
      const response = await axios.post('https://cams-exim.com/api/getUnits', {
        headers: {
          'Content-Type': 'application/json',
        },
      })
          ...
          <div className="flex gap-5">
            ...
            <div className="w-1/2 bg-white shadow-lg p-2 min-h-36 rounded-md">
              ...
              <span>
                ...
                Object.keys(contactDetails || contactData).length > 0 ? (
                  ...
                  <div className="flex flex-col gap-1">
                    <p className="text-sm text-gray-800 font-semibold">
                      {contactData?.data?.user_firstname || 'Loading'}{' '}
                      {contactData?.data?.user_lastname}
                    </p>
                    <p className="text-sm text-gray-800 font-semibold break-words">
                  ...
                  {productList.map((product) => (
                    ...
                    >
                      ...
                      <div className="absolute transition-all duration-100 gap-4 flex right-7 top-9 lg:top-7">
                        ...
                        <span
                          className="text-garyShade hover:text-lightRed"
                          onClick={() => {
